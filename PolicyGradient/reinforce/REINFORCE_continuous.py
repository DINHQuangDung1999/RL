...
class REINFORCE:
    ...
    def __init__(self, num_inputs, hidden_size, dim_action_space, lr_pi = 3e-4,\
                 lr_vf = 1e-3, baseline = False, gamma = 0.99, train_v_iters = 1):

        self.gamma = gamma
        self.dim_action_space = dim_action_space
        self.policy = Gaussian_Policy(num_inputs, hidden_size, dim_action_space)# use a different policy depending on the action space being continuous or note.
